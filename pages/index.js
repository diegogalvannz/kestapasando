        ...
        <div style={{ maxWidth:'1200px', margin:'0 auto' }}>
          <Link href="/">
            <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'14px', cursor:'pointer' }}>
              ...
              <div>
                <div style={{ fontSize:'10px', fontWeight:'700', color:'rgba(255,255,255,0.5)', letterSpacing:'3px', textTransform:'uppercase', marginBottom:'2px' }}>Qué chingados</div>
                <div style={{ fontSize:'24px', fontWeight:'900', color:'white', letterSpacing:'-0.5px', lineHeight:1 }}>está pasando?</div>
